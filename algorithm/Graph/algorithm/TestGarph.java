...
public class TestGarph {
	public static void main(String[] args) {
		String[] vertices = {"Seattle", "San Francisco", "Los Angeles", 
			"Denver", "Kansas City", "Chicago", "Boston", "New York",
			"Aletna", "Miami", "Dallas", "Houston"};
		int[][] edges = {
				{0, 1}, {0, 3}, {0, 5}, 
				{1, 0}, {1, 2}, {1, 3},
				{2, 1}, {2, 3}, {2, 4}, {2, 10},
		...
		System.out.println("The edges for graph1£º ");
				graph1.printEdges();
		System.out.println("Adjacecy matrix for graph1:");
		...
		System.out.println("The number of vertices in graph2: " +
				graph2.getSize());
		System.out.println("The edges of graph2:" );
		graph2.printEdges();
